...
public final class SarumanLannisters {
    public static void main(String[] args) {
        int SOLDERS_LANNISTER = 50; // количество пехотинцев у Ланнистеров
        int SOLDERS_SARUMANA = 70; // количество орков в войске Сарумана
        int TOTAL_SOLDIERS = SOLDERS_LANNISTER + SOLDERS_SARUMANA; //общее количество пехоты
